...
variable "super_router" {
  ...
  validation {
    condition = (
      var.super_router.inspect.policy_diff.previous_reachability == null
      || var.super_router.inspect.policy_diff.previous_reachability.schema_version == 1
    )
  ...
  validation {
    condition = (
      var.super_router.inspect.policy_diff.previous_reachability == null
      || alltrue([
        for entry in var.super_router.inspect.policy_diff.previous_reachability.entries :
